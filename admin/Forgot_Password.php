...
foreach($data as $info){
    if(isset($_POST['email']) && isset($_POST['password']) && isset($_POST['password_cf'])){
      if($info['email'] == $_POST['email'] && $_POST['password'] == $_POST['password_cf'] && $info['role'] = 1 ){    
          $sql_update = "UPDATE users SET password = '$password', cf_password = '$password' WHERE email = '$email'";
        ...
        $thongbao = "Email hoặc Mật Khẩu không khớp, Vui lòng nhập lại";
      }
    }
}
?>
      ...
      <div class="container">
        ...
        <div class="login-form">
          <form action="<?$_SERVER['PHP_SELF']?>" method="POST">
            <input type="em" name="email" placeholder="Email">
            <input type="text" name="password" placeholder="New Password">
            <input type="text" name="password_cf" placeholder="Confirm Password">
            <?
              if(isset($thongbao)){
                echo $thongbao;
              }
             ...
             ?>
              ...
              <a href="http://asm/admin/login_admin.php">Return to the login page</a>
           
            <button type="submit" name="dangnhap">COMPLETE</button>
          </form>
        </div>
